            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-cream-card rounded-none shadow-sm border border-warm-border overflow-hidden flex flex-col md:flex-row animate-fadeInUp">
                    ...
                    <div className="md:w-[45%] bg-cream-deep p-8 flex flex-col relative min-h-[400px] border-b md:border-b-0 md:border-r border-warm-border">
                        ...
                        <div className={`absolute top-8 right-8 flex items-center gap-2 px-3 py-1 text-[10px] font-bold uppercase tracking-widest border ${product.complianceStatus === 'Approved' ? 'bg-sage-deep/10 text-sage-deep border-sage-deep' : 'bg-amber-gold/10 text-amber-gold border-amber-gold'}`}>
                            <div className={`w-2 h-2 rounded-none ${product.complianceStatus === 'Approved' ? 'bg-sage-deep' : 'bg-amber-gold animate-pulseRing'}`}></div>
                        ...
                        <div className="bg-cream-deep border border-warm-border p-8 mb-10">
                            <div className="grid grid-cols-2 gap-y-6 text-sm">
                                <div>
                                    ...
                                    <span className="text-charcoal font-bold tracking-wide">{product.manufacturer}</span>
                                </div>
                                <div>
                                    <span className="block text-text-secondary font-bold uppercase tracking-widest text-[10px] mb-2">Formulation</span>
                                    <span className="text-charcoal font-bold tracking-wide">{product.dosage_form}</span>
                                </div>
                                <div>
                                    <span className="block text-text-secondary font-bold uppercase tracking-widest text-[10px] mb-2">Storage Protocol</span>
                                    <span className="text-charcoal font-bold tracking-wide">{product.storage}</span>
                                </div>
                                <div>
