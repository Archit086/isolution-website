        ...
        if (this.state.hasError) {
            return (
                <div className="flex flex-col items-center justify-center min-h-screen bg-surface-muted p-4">
                    <div className="bg-white p-8 animate-fadeInUp shadow-lg rounded-2xl max-w-md w-full text-center">
                        ...
                        <p className="text-text-secondary mb-6">An unexpected error occurred in the application.</p>
                        <button
